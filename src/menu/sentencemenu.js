...
var getMenu=function(obj){
	...
	return [
	{name:"Bookmark",component:<HomeView obj={obj}/>,icon:bookmarkicon,badgeText:'2',flex:5},
	{name:"Dictionary",component:<HomeView obj={obj}/>,icon:dicticon,badgeText:'5',flex:3}
	];
};
